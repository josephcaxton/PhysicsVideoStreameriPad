...
-(NSString *)WorkOutSubsriptionInDays:(NSString*)theProductID{
    ...
    if ([[theProductID lowercaseString] isEqualToString:@"physics1week"] ){
   ...
   else if ([[theProductID lowercaseString] isEqualToString:@"physicsipad1month"] ){
        
        return @"31";
        
    }
    
    else if ([[theProductID lowercaseString] isEqualToString:@"physicsipad3months"] ){
        
        return @"93";
        
    }
    else if ([[theProductID lowercaseString] isEqualToString:@"physicsipad6months"] ){
        
        return @"186";
        
    }
    
    else if ([[theProductID lowercaseString] isEqualToString:@"physicsipad9months"] ){
        
        return @"279";
        
    }
    else if ([[theProductID lowercaseString] isEqualToString:@"physicsipad12months"] ){
...
-(void)SendToLearnersCloud{
    ...
    VerificationAppID = @"7"; //Physics iPad
