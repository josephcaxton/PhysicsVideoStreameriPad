...
- (void)viewDidLoad {
	...
	[listofItems addObject:@"GCSE Physics WJEC Examination Coverage"];
    [listofItemsFileNames addObject:@"GCSE-Physics-WJEC-Examination-Coverage"];
    
    [listofItems addObject:@"GCSE Physics OCR Gateway B Examination-Coverage"];
    [listofItemsFileNames addObject:@"GCSE-Physics-OCR-Gateway-B-Examination-Coverage"];
    
    [listofItems addObject:@"GCSE Physics OCR 21st Century A Examination Coverage"];
    [listofItemsFileNames addObject:@"GCSE-Physics-OCR-21st-Century-A-Examination Coverage"];

    [listofItems addObject:@"GCSE Physics Edexcel Examination Coverage"];
    [listofItemsFileNames addObject:@"GCSE-Physics-Edexcel-Examination-Coverage"];

    [listofItems addObject:@"GCSE Physics CCEA Examination Coverage"];
    [listofItemsFileNames addObject:@"GCSE-Physics-CCEA-Examination-Coverage"];

    [listofItems addObject:@"GCSE Physics AQA Examination Coverage"];
