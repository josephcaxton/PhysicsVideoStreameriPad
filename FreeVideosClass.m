...
- (void)viewDidLoad {
    ...
    NSString *queryFeed = [NSString stringWithFormat:@"%@/iosStreamv2/Physics/PhysicsConfig.xml",domain];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    else
    {
        ...
        NSUserDefaults *prefs = [NSUserDefaults standardUserDefaults];
        if([[prefs objectForKey:@"AddOneFreePhysics"] isEqualToString:@"1"]){
...
- (void)reviewPressed {
    ...
    // Report to  analytics
    NSError *error;
    if (![[GANTracker sharedTracker] trackEvent:@"User Sent to Review Physics Videos iPad at app store"
                                         action:@"User Sent to Review Physics Videos iPad at app store"
                                          label:@"User Sent to Review Physics Videos iPad at app store"
                                          value:1
                                      withError:&error]) {
